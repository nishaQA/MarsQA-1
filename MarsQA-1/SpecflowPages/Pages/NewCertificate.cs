...
namespace MarsQA_1.SpecflowPages.Pages
{
    class NewCertificate
    {
        ...
        private static IWebElement YearDropdownopt => Driver.driver.FindElement(By.XPath("/html/body/div[1]/div/section[2]/div/div/div/div[3]/form/div[5]/div[1]/div[2]/div/div/div[2]/div[2]/select/option[8]"));
       ...
       // private static IWebElement UpdateCertificateFromTextBox => Driver.driver.FindElement(By.XPath("/html/body/div[1]/div/section[2]/div/div/div/div[3]/form/div[5]/div[1]/div[2]/div/table/tbody[last()]/tr/td/div/div/div[2]/input"));
...

        {
            ...
            CertifiedFromTextBox.SendKeys("ITB");

            YearDropdown.Click();
            YearDropdownopt.Click();
        ...
        public static void AddDataValidate()
        {
            ...
            //IWebElement MessageBox = Driver.driver.FindElement(By.XPath());

           // Assert.That(MessageBox.Text == "ISTQB has been added to your certification", "Actual Message an Expected Message do not match.");
            Assert.AreEqual("ISTQB has been added to your certification", Driver.driver.FindElement(By.XPath("//div[@class='ns-box-inner']")).Text);
        ...
        public static void UpdateStep()
        {
            ...
            if (findRecordCreated.Text == "ITQL")
            {
                Driver.TurnOnWait();
                ...
                UpdateCertificateTextBox.SendKeys("ITB");
        ...
        public static void ValidateUpdateData()
        {
            ...
            //Assert.That(UpdatedMessageBox.Text == "ITIL has been updated to your certification", "Actual UpdatedMessage an Expected Message do not match");
           // Assert.AreEqual("IT has been updated to your certification", Driver.driver.FindElement(By.XPath("//div[@class='ns-box-inner']")).Text);
        }
